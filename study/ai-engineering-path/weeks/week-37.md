...
> RL intuition, LoRA, post-training; outline `aieng-p06-finetuning-memo`
...
- Repo: (see [[../projects/p6-finetuning-memo]] for repo name)
- Commits this week:
- Demo / screenshot:
...
*Prev: [[week-36]] · Back to [[../02-progress-tracker]] · Next: [[week-38]]*
