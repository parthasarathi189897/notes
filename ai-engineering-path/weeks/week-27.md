...
> Cross-encoders, embedding adaptors; copy P3 → `aieng-p04-rag-v2-evaluated`, add 2 improvements
...
- Repo: (see [[../projects/p4-rag-v2-evaluated]] for repo name)
- Commits this week:
- Demo / screenshot:
...
*Prev: [[week-26]] · Back to [[../02-progress-tracker]] · Next: [[week-28]]*
